...
#SBATCH --account=lsfb
#
#SBATCH --output=./out/mstx/%A_%a.out
...
config_files=(
  "../../configs/hydra/mstx/mstx_base.yaml"
  "../../configs/hydra/mstx/mstx_xsmall.yaml"
  "../../configs/hydra/mstx/mstx_small.yaml"
  "../../configs/hydra/mstx/mstx_medium.yaml"
  "../../configs/hydra/mstx/mstx_large.yaml"
)
