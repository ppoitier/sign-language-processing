#!/bin/bash
# Submission script for Lucia — annotation noise robustness.
# 6 configs: 3 noise levels (low, medium, high) × 2 datasets.
#
#SBATCH --job-name=sls_mstcn_noise
...
#SBATCH --account=lsfb
#
#SBATCH --output=./out/8-mstcn-noise/%A_%a.out
