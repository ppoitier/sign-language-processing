...
from slp.config.load_config import load_recognition_task_config
from slp.config.loading.tasks import load_recognition_task
...
def launch_recognition_training(config_path):
    config = load_recognition_task_config(config_path)
    ...
    task_id, data_sets, data_loaders, module = load_recognition_task(config)
