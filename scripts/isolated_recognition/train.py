...
from slp.core.config.experiment import IsolatedRecognitionClassificationTaskConfig
...
from slp.trainers.isolated_recognition import load_isolated_recognition_trainer
...
def launch_isolated_recognition_training(config_path):
    config: IsolatedRecognitionClassificationTaskConfig = parse_config(config_path, IsolatedRecognitionClassificationTaskConfig)
    pprint(config)
